...
public class OrderActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //seting the textview with the message retreived from main activity
    ...
    public void onRadioButtonClicked(View view) {
        ...
        //create a boolean variable and use the method checked to determine if a radion button is checked
